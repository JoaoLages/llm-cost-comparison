...
def calculate_min_vram(
    ...
    if precision_upper == "FP8":
        model_vram = model_vram_fp8
        bytes_per_param = 1
    elif precision_upper == "FP16":
        model_vram = model_vram_fp16
        bytes_per_param = 2
    else:
        raise ValueError(f"Invalid precision: {precision}. Must be 'FP8' or 'FP16'")
